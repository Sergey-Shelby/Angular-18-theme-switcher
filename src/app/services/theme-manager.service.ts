...
export class ThemeManager {
  ...
  setTheme = (theme: string) => {
    if (this._window !== null) {
      const isDark = theme === 'dark' || (theme === 'auto' && this._window.matchMedia('(prefers-color-scheme: dark)').matches);
      this.document.documentElement.setAttribute('data-bs-theme', isDark ? 'dark' : 'light');
      this._isDarkSub.next(isDark);
